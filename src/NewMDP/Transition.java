 ...
 * Essentially a copy of the simulator class without the prints.
 * Used to get next State without printing steps
 */
public class Transition {
    ...
    public Transition(State state, ProblemSpec ps) {
    ...
    /**
     * Copied from Simulator to get nextState
     * @param a
     * @return
    ...
    public Action selectRandomAction() {
        ...
        int CT = ps.getCT();
        int DT = ps.getDT();
        int TiT = ps.NUM_TYRE_MODELS;
        int PressureT = ps.TIRE_PRESSURE_LEVELS;
